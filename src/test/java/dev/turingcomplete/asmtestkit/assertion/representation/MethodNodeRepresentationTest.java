...
import static dev.turingcomplete.asmtestkit.assertion.representation.MethodNodeRepresentation.INSTANCE;
...
class MethodNodeRepresentationTest {
  ...
  void testToStringOf() throws IOException {
    ...
    assertThat(INSTANCE.toStringOf(myMethod))
            .isEqualTo("// Attribute: Name1Content\n" +
                       ...
                       "@dev.turingcomplete.asmtestkit.assertion.__helper.InvisibleAnnotationB // invisible\n" +
                       ...
                       "  // Local variable annotation: @dev.turingcomplete.asmtestkit.assertion.__helper.VisibleTypeParameterAnnotationA // reference: local_variable; path: null // range: #3 L3-L2\n" +
                       "  // Local variable annotation: @dev.turingcomplete.asmtestkit.assertion.__helper.InvisibleTypeParameterAnnotationA // reference: local_variable; path: null // range: #4 L4-L2 // invisible\n" +
                       "  // Try catch block: @dev.turingcomplete.asmtestkit.assertion.__helper.InvisibleTypeParameterAnnotationA // reference: exception_parameter=0; path: null // invisible\n" +
  ...
  void testDefaultAnnotationValueOtherAnnotation() throws IOException {
    @Language("Java")
    String myClass = "import dev.turingcomplete.asmtestkit.assertion.__helper.VisibleAnnotationA;" +
                     "import java.lang.annotation.Annotation;@interface MyAnnotation  {" +
    ...
    assertThat(INSTANCE.toStringOf(annotationMethod))
            .isEqualTo("(1025) public abstract dev.turingcomplete.asmtestkit.assertion.__helper.VisibleAnnotationA value()\n" +
                       "  // Annotation default: @dev.turingcomplete.asmtestkit.assertion.__helper.VisibleAnnotationA\n" +
                       "  // Max locals: 0\n" +
                       "  // Max stack: 0");
  }
