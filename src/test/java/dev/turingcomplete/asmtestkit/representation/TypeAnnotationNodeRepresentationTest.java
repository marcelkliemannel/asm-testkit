...
import static dev.turingcomplete.asmtestkit.representation.TypeAnnotationNodeRepresentation.INSTANCE;
...
class TypeAnnotationNodeRepresentationTest {
  ...
  @Language("Java")
  private static final String MY_CLASS = "import dev.turingcomplete.asmtestkit.__helper.VisibleTypeParameterAnnotationA;" +
  ...
  void testToStringOf() throws IOException {
    ...
    Assertions.assertThat(INSTANCE.toStringOf(myClassNode.visibleTypeAnnotations.get(0)))
              .isEqualTo("@dev.turingcomplete.asmtestkit.__helper.VisibleTypeParameterAnnotationA // reference: class_extends=-1; path: null");

    Assertions.assertThat(INSTANCE.toStringOf(myClassNode.fields.get(0).visibleTypeAnnotations.get(0)))
              .isEqualTo("@dev.turingcomplete.asmtestkit.__helper.VisibleTypeParameterAnnotationA // reference: field; path: [");
  }
  ...
  void testToSimplifiedStringOf() throws IOException {
    ...
    Assertions.assertThat(INSTANCE.doToSimplifiedStringOf(myClassNode.visibleTypeAnnotations.get(0)))
              .isEqualTo("@dev.turingcomplete.asmtestkit.__helper.VisibleTypeParameterAnnotationA");
